							...
							.ajax({
								...
								success : function(data) {
									...
									if(!jsonData.validAddress){
										...
										showConfirmMessage('Please enter a valid delivery address.');
...
function showAddressError(){
	...
	$('#addressMessage').show();
	$('#addressMessage')
			.text('ENTER A VALID DELIVERY ADDRESS');
	location.hash='addressMessage';
}

function showOrderUpdateError(){

	$('#orderMessage').show();
	$('#orderMessage')
			.text('ROSY HAD A PROBLEM UPDATING YOUR ORDER, PLEASE TRY AGAIN.');
	location.hash='orderMessage';
}
...
function openPaymentModal(){
    ...
    redirectUrl = shortUrl + "/payment.html?ro=" + getURLParameter("ro");
    console.log("sending to: " + redirectUrl);
